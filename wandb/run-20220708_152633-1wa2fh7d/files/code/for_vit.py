...
import wandb
wandb.init(project= "one_patch_attack_deit_tiny_thesis")
artifact = wandb.Artifact("deit_tiny1_samples_" + str(wandb.run.id) , type="prediction")
...
net = create_model('deit_tiny_patch16_224', pretrained=True)
net.to(device)
net.eval()
...
path_to_resources = '/home/abass.abdulsalam/Documents/imgnet/processed_va;/'
batch_size = 1
